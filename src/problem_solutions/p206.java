...
public final class p206 implements EulerSolution
{
	public static void main(String[] args) {
		System.out.println(new p206().solve());
	}

   /**
    * The major optimization is to do arithmetic in base 10 in the main loop, avoiding "expensive floatingpoint"
    ...
    */
	public String solve() {
        ...
        while (!isConcealedSquare(n2digits))
        {
            ...
            n += 10;
            add10Pow(ndigits, 1); // Now n2digits = n^2
        }
