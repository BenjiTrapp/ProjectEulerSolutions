...
public final class p169 implements EulerSolution
{
	...
	public static void main(String[] args) {
		System.out.println(new p169().solve());
	}

	private static final BigInteger NUMBER = BigInteger.TEN.pow(25);
    private Map<List<BigInteger>,BigInteger> ways = new HashMap<>(); // Memoization
     ...
     */
	public String solve() {return countWays(NUMBER, NUMBER.bitLength() - 1, 2).toString();}
