...
public final class p066 implements EulerSolution {
	...
	public static void main(String[] args) {
		System.out.println(new p066().solve());
	}
	 ...
	 * (This is a tsolvecation of the continued fraction with only one period minus the last term.)
	 * 
	...
	public String solve() {
		...
		for (int n = 2; n <= 1000; n++) {
			if (ProjectEulerLibrary.isSquare(n))
				continue;
