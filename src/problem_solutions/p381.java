...
public final class p381 implements EulerSolution
{
	public static void main(String[] args) {
		System.out.println(new p381().solve());
	}

    public String solve()
    {
        boolean[] isPrime = ProjectEulerLibrary.listPrimality(ProjectEulerLibrary.pow(10, 8));
        long sum = 0;
    ...
    {
        return (int) ((long) (p - 3) * ProjectEulerLibrary.reciprocalMod(8 % p, p) % p);
    }
}
