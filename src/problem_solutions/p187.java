...
public final class p187 implements EulerSolution
{
	public static void main(String[] args) {
		System.out.println(new p187().solve());
	}

	private static final int LIMIT = ProjectEulerLibrary.pow(10, 8) - 1;
    ...
    {
        int count = 0;
        int[] primes = ProjectEulerLibrary.listPrimes(LIMIT / 2);

        for (int i = 0, sqrt = ProjectEulerLibrary.sqrt(LIMIT); i < primes.length && primes[i] <= sqrt; i++)
        {
