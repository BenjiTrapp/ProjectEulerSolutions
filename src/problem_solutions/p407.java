...
public final class p407 implements EulerSolution
{
	public static void main(String[] args) {
		System.out.println(new p407().solve());
	}
	...
	public String solve()
    {
        ...
        */
        ...
        /* Temporary arrays */
        int[] solns = new int[1 << maxNumPrimeFactors]; solns[0] = 0;
        ...
        for (int i = 1; i <= LIMIT; i++)
        {
            ...
            for (int q : factorization)
            {
                /*
                   ...
                   See: http://de.wikipedia.org/wiki/Chinesischer_Restsatz
                */
                int recip = ProjectEulerLibrary.reciprocalMod(q % modulus, modulus);
