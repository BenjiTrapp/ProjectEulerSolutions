...
public final class p111 implements EulerSolution
{
	public static void main(String[] args) {
		System.out.println(new p111().solve());
	}
	...
	public String solve()
	{
		primes = ProjectEulerLibrary.listPrimes((int) ProjectEulerLibrary.sqrt(pow(10, DIGITS)));
			...
			for (int rep = DIGITS; rep >= 0; rep--)
			{
				...
				for (long i = 0; i < count; i++)
				{
				    /*
					  ...
					  Build initial array. For example, if DIGITS=7, digit=5, rep=4, i=123,
					  then the array will be filled with 5,5,5,5,1,4,7.
					*/
