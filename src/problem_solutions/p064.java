...
public final class p064 implements EulerSolution
{
	...
	public static void main(String[] args) {System.out.println(new p064().solve());}
	...
	public String solve()
	{
		...
		for (int i = 1; i <= 10000; i++)
			if (!ProjectEulerLibrary.isSquare(i) && getSqrtContinuedFractionPeriod(i) % 2 == 1)
				count++;
