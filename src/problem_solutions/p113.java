...
public final class p113 implements EulerSolution {
	...
	public static void main(String[] args) {
		System.out.println(new p113().solve());
	}
	...
	public String solve()
	{
		BigInteger increasing = ProjectEulerLibrary.binomial(DIGITS + 9, 9).subtract(BigInteger.ONE);
		BigInteger decreasing = ProjectEulerLibrary.binomial(DIGITS + 10, 10).subtract(BigInteger.valueOf(DIGITS + 1));
