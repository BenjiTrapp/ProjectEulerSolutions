...
public final class p028 implements EulerSolution
{
	...
	private static final int SIZE = 1001;  // The Size MUST be odd otherwise Zombies will eat your Mum...

	/**
	 * The Intention behind the Algorithm/Solution:
	 *
	...
	public String solve()
	{
		...
		for (int n = 3; n <= SIZE; n += 2)
			sum += 4 * n * n - 6 * (n - 1); //TODO: Magic Numbers are for lunatics
