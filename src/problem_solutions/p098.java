...
public final class p098 implements EulerSolution
{
	...
	public static void main(String[] args) {
		System.out.println(new p098().solve());
	}
	...
	private static int maxSquarePair(String a, String b, int index, int[] assignments, boolean[] isDigitUsed)
	{
		...
		if (index == a.length())
		{
			...
			if (ProjectEulerLibrary.isSquare(aNum) && ProjectEulerLibrary.isSquare(bNum))
