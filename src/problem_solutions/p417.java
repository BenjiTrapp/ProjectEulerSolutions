...
public final class p417 implements EulerSolution {
    ...
    public static void main(String[] args) {
        System.out.println(new p417().solve());
    }

    /**
     * Intention behind the Sotlution:
     * ===============================
     * <p>
    ...
    private static final int LIMIT = ProjectEulerLibrary.pow(10, 8);

    /**
     * Solution requires about ~400 MB
     */
    public String solve() {
        ...
        int[] smallestPrimeFactor = calcSmallestPrimeFactors(primes);
        ...
        */
        ...
        /* Some garbage collection voodoo */
        smallestPrimeFactor = null;
        System.gc();

       /*
           Compute periods for each number that is coprime with 2 and 5, based on the prime power
    ...
    private int[] calcPrimePowerPeriods(long[] primePowersAndTotients, int[] smallestPrimeFactor) {
        ...
        for (int i = 0; i < primePowersAndTotients.length; i++) {
            ...
            while (remainingFactors > 1) {
                ...
                if (ProjectEulerLibrary.powMod(10, period / q, primePow) == 1)
                    period /= q;
                remainingFactors /= q;
            }
            result[i] = period;
    ...
    private static int lcm(int x, int y) {
        return x / ProjectEulerLibrary.gcd(x, y) * y;
    }
