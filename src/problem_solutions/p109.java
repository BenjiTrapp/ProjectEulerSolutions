...
public final class p109 implements EulerSolution
{
	...
	public static void main(String[] args) {
		System.out.println(new p109().solve());
	}
	...
	/**
	   Number of ways to get exactly 'total' points in exactly 'throwz' throws,
	   using items (unordered) from the 'points' list with index less than or equal to 'maxIndex'.
	 */
