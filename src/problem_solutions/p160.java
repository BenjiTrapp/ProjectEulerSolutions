...
public final class p160 implements EulerSolution
{
	...
	public static void main(String[] args) {
		System.out.println(new p160().solve());
	}

	public String solve() {return Long.toString(factorialSuffix(1000000000000L));}
	...
	private static long factorialSuffix(long n)
    {
		...
		return factorialish(n) * ProjectEulerLibrary.powMod(2, (int) twos, 100000) % 100000;
	}
    ...
    */
     ...
     * For example, evenFactorialish(9) only considers the numbers {2, 4, 6, 8}. Divide each number by 2 to get
     * {1, 2, 3, 4}. Thus evenFactorialish(9) = factorialish(4).
     */
     ...
     * By definition, oddFactorialish() never considers any number that has a factor of 2. The product of the numbers
     * that not a multiple of 5 are accumulated by factorialCoprime(). Those that are a multiple of 5 are handled
     * recursively by oddFactorialish(), noting that they are still odd after dividing by 5.
     */
     ...
     * The input argument can be taken modulo 10^5 because factorialoid(10^5) = 1, and each
     * block of 10^5 numbers behaves the same.
     */
     ...
     * For example, countFactors(25, 5) = 6 because {5, 10, 15, 20} each has one factor of 5, and 25
     * has two factors of 5.
     */
